				...
				<div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
					<div class="service" data-height="height">
						...
						<div class="service-info">
							<h3>Реальная забота о близких</h3>
							<p class="margin-b-5">Вас беспокоит экология планеты? Переходите на уникальные качественные продукты Greenway!</p>
						</div>
			...
			<div class="col-sm-4 sm-margin-b-2">
				<div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".2s">
					<div class="service" data-height="height">
						...
						<div class="service-info">
							<h3>Быстрый старт бизнеса</h3>
							<p class="margin-b-5">Начните сейчас и уже через год ваша машина и квартира будут круче, чем у бывшего босса!</p>
						</div>
						<a href="#" class="content-wrapper-link"></a>
					</div>
				</div>
			...
			<div class="col-sm-4">
				<div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".1s">
					<div class="service" data-height="height">
						...
						<div class="service-info">
							<h3>Маркетинг нового поколения</h3>
							<p class="margin-b-5">А вы уже просчитали шансы вашей команды с новыми условиями Greenway?</p>
						</div>
						<a href="#" class="content-wrapper-link"></a>
					</div>
				</div>
			...
			<div class="col-sm-4 sm-margin-b-2">
				<div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".4s">
					<div class="service" data-height="height">
						...
						<div class="service-info">
							<h3>Первые</h3>
							<p class="margin-b-5">Greenway дает простые инструменты для получения больших доходов.</p>
						</div>
						<a href="#" class="content-wrapper-link"></a>
					</div>
				</div>
			...
			<div class="col-sm-4 sm-margin-b-2">
				<div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".5s">
					<div class="service" data-height="height">
						...
						<div class="service-info">
							<h3>Свобода</h3>
							<p class="margin-b-5">Лучшие отели, отличная компания и уверенность в завтрашнем дне!</p>
						</div>
						<a href="#" class="content-wrapper-link"></a>
					</div>
				</div>
			...
			<div class="col-sm-4">
				<div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".6s">
					<div class="service" data-height="height">
						...
						<div class="service-info">
							<h3>Успех</h3>
							<p class="margin-b-5">Компания проводит лидерские события, и вы можете присоединиться к нашей команде путешественников.</p>
						</div>
						<a href="#" class="content-wrapper-link"></a>
					</div>
				</div>
		...
		<div class="swiper-slider swiper-clients">
			...
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<img class="swiper-clients-img" src="<?php echo get_template_directory_uri(); ?>/img/clients/01.png" alt="Clients Logo">
				</div>
				<div class="swiper-slide">
					<img class="swiper-clients-img" src="<?php echo get_template_directory_uri(); ?>/img/clients/02.png" alt="Clients Logo">
				</div>
				<div class="swiper-slide">
					<img class="swiper-clients-img" src="<?php echo get_template_directory_uri(); ?>/img/clients/03.png" alt="Clients Logo">
				</div>
				<div class="swiper-slide">
					<img class="swiper-clients-img" src="<?php echo get_template_directory_uri(); ?>/img/clients/04.png" alt="Clients Logo">
				</div>
				<div class="swiper-slide">
					<img class="swiper-clients-img" src="<?php echo get_template_directory_uri(); ?>/img/clients/05.png" alt="Clients Logo">
				</div>
				<div class="swiper-slide">
			...
			<div class="swiper-slider swiper-testimonials">
				...
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<blockquote class="blockquote">
							<div class="margin-b-20">
								Чистящая паста Greenway Mystik.
							</div>
							<div class="margin-b-20">
					...
					<div class="swiper-slide">
						<blockquote class="blockquote">
							<div class="margin-b-20">
								Набор для специй GreenWay Oriental way.
							</div>
							<div class="margin-b-20">
								Очень удобная, комфортная, организационная, практичная, красивая вещь. Удобно держать различные специи в специально отведенных для этого местах. Стеклянные небольшие баночки, каждая из них подписывается. Согласитесь, что покупать приправки в бумажных рекламированных пакетиках дороже, чем вы приобретаете приправы на развес. После чего наполняете свои баночки не переплачивая за упаковку. К тому же, баночка всегда содержит ваши любимые лакомства без мокроты и пересыхания, закрыла крышечку и положила на место, очень удобно и комфортно. Оригинальный дизайн, удобноя подставочка из дерева. И все на своих местах.
							</div>
							<p><span class="fweight-700 color-link">Irishkus</span>. Россия, Иркутск</p>
						</blockquote>
					</div>
