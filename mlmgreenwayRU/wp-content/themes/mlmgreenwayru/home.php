...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/1920x1080/01.jpg" alt="Slider Image">
            <div class="container">
                <div class="carousel-centered">
                    <div class="margin-b-40">
                        <h1 class="carousel-title">Greenway</h1>
                        <p>Основная задача компании производство и распространение новейших экологических продуктов<br /> которые помогут сделать жизнь лучше.</p>
                    </div>
                    <a href="#" class="btn-theme btn-theme-sm btn-white-brd text-uppercase">Запрос на сотрудничество</a>
                </div>
            </div>
        </div>
        <div class="item">
            <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/1920x1080/02.jpg" alt="Slider Image">
            <div class="container">
                <div class="carousel-centered">
                    <div class="margin-b-40">
                        <h2 class="carousel-title">Greenway</h2>
                        <p>Бренд Greenway можно считать настоящим интегратором современных научных новинок,<br /> аналогов которым найти практически не реально.</p>
                    </div>
                    <a href="#" class="btn-theme btn-theme-sm btn-white-brd text-uppercase">Запрос на сотрудничество</a>
                </div>
            </div>
...
<div class="promo-section overflow-h">
    ...
    <div class="promo-section-img-right">
        <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/970x970/01.jpg" alt="Content Image">
    </div>
</div>
<!-- End Promo Section -->
        ...
        <div class="masonry-grid">
            ...
            <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-8">
                ...
                <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                    <div class="work-overlay">
                        <img class="full-width img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/800x400/01.jpg" alt="Portfolio Image">
                    </div>
            ...
            <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-4">
                ...
                <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".2s">
                    <div class="work-overlay">
                        <img class="full-width img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/397x400/01.jpg" alt="Portfolio Image">
                    </div>
                    <div class="work-content">
            ...
            <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-4">
                ...
                <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".3s">
                    <div class="work-overlay">
                        <img class="full-width img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/397x300/01.jpg" alt="Portfolio Image">
                    </div>
                    <div class="work-content">
                        <h3 class="color-white margin-b-5">Clean Design</h3>
                        <p class="color-white margin-b-0">Lorem ipsum dolor sit amet consectetur adipiscing</p>
            ...
            <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-4">
                ...
                <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".4s">
                    <div class="work-overlay">
                        <img class="full-width img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/397x300/02.jpg" alt="Portfolio Image">
                    </div>
                    <div class="work-content">
                        <h3 class="color-white margin-b-5">Clean Design</h3>
                        <p class="color-white margin-b-0">Lorem ipsum dolor sit amet consectetur adipiscing</p>
            ...
            <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-4">
                ...
                <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".5s">
                    <div class="work-overlay">
                        <img class="full-width img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/397x300/03.jpg" alt="Portfolio Image">
                    </div>
                    <div class="work-content">
                        <h3 class="color-white margin-b-5">Clean Design</h3>
                        <p class="color-white margin-b-0">Lorem ipsum dolor sit amet consectetur adipiscing</p>
